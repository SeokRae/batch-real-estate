...
CREATE TABLE TB_REAL_ESTATE
(
    ID                   BIGINT       NOT NULL AUTO_INCREMENT,
    RECEIPT_YEAR         VARCHAR(255) NULL,
    DISTRICT_CODE        VARCHAR(255) NULL,
    DISTRICT_NAME        VARCHAR(255) NULL,
    LEGAL_DONG_CODE      VARCHAR(255) NULL,
    LEGAL_DONG_NAME      VARCHAR(255) NULL,
    LOT_NUMBER_TYPE      VARCHAR(255) NULL,
    LOT_NUMBER_TYPE_NAME VARCHAR(255) NULL,
    MAIN_NUMBER          VARCHAR(255) NULL,
    SUB_NUMBER           VARCHAR(255) NULL,
    BUILDING_NAME        VARCHAR(255) NULL,
    CONTRACT_DATE        VARCHAR(255) NULL,
    REAL_ESTATE_PRICE    VARCHAR(255) NULL,
    BUILDING_AREA        VARCHAR(255) NULL,
    LAND_AREA            VARCHAR(255) NULL,
    FLOOR                VARCHAR(255) NULL,
    RIGHT_TYPE           VARCHAR(255) NULL,
    CANCEL_DATE          VARCHAR(255) NULL,
    BUILDING_YEAR        VARCHAR(255) NULL,
    BUILDING_TYPE        VARCHAR(255) NULL,
    REPORT_TYPE          VARCHAR(255) NULL,
    REPORT_AGENT         VARCHAR(255) NULL,
    CONSTRAINT PK_TB_REAL_ESTATE PRIMARY KEY (ID)
);